    ...
    return (
        <div className="relative flex flex-col md:flex-row min-h-screen justify-around items-center py-14 md:py-8 bg-[#030303]">
            ...
            <div className="flex flex-col pl-3 justify-center items-center md:items-start gap-3 md:gap-4 w-full flex-1 pt-16 md:pt-3">
                ...
                <h1 className="text-white text-xl md:text-3xl font-bold text-center md:text-start">
                    Education: <span className="text-blue-700">BSCS - Virtual University of Pakistan</span>
                </h1>
                <p className="text-white text-xl md:text-2xl font-bold text-center md:text-start pt-4">
                    A passionate Android Developer with expertise in building modern, high-performing applications.
                </p>
